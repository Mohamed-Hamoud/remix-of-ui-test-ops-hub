 ...
 * Card for displaying category with reorder handle
 * 
 * HAML Equivalent:
 * ```haml
 ...
 *     .flex.gap-1
 *       %button.icon-btn{ title: 'Edit Category' }
 *         = lucide_icon "edit", class: "h-4 w-4"
 *       %button.icon-btn{ title: 'Delete Category' }
...
export function CategoryCard({ name, productCount, onEdit, onDelete, onDrag }: CategoryCardProps) {
   return (
