   ...
   return (
     <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card card-shadow p-4 space-y-3">
        ...
        {/* Row 2: Date range + Checkboxes + Apply */}
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <label className="flex items-center gap-1.5 text-sm cursor-pointer select-none">
              ...
              />
              <span className="text-warning text-xs font-medium">SLA Breached</span>
            </label>
          </div>

          <div className="flex-1" />

          <button className="btn-primary px-4 h-9 flex items-center gap-2 text-sm">
